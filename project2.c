...
void calculate_bill()
{
    ...
    else if (total_bill >= 2000 && total_bill < 4000)
    {
...
void main()
{
    ...
    printf("|-------------------------------------|\n");
    printf("| greater than 1000 buy 5%% discount   |\n");
    printf("|-------------------------------------|\n");
    printf("| greater than 2000 buy 10%% discount |\n");
    printf("|-------------------------------------|\n");
    printf("| greater than 4000 buy 15%% discount |\n");
    printf("***************************************\n\n");
    printf("Please enter all product bought by you\n");
    printf("items avilable:- sugar, milk, vegetable masala, washing powder,salt, poha, oil, tooth paste, hair conditionar,coffee\n");
    for (int i = 0; i < 20; i++)
    {
